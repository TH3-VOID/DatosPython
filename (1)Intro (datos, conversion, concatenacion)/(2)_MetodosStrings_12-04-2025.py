...
print(
    animal.capitalize()
)  # convierte todo en texto normal, T no paso a mayuscula debido a que hay un espacio en [0]
...
print(
    animal.find("e")
)  # este lo que hace es una busqueda si encuetra manda en que posicion esta, sino -1
print(
    animal.replace("tjOn", "Tejon")
)  # este tiene o puede cambiar el string "campo antiguo","campo nuevo", si no encuentra no hace algo
